...
from app.core.dependencies.events import require_event_actor, EventActor, require_organizer_member
...
async def patch_event(
    ...
    event = await event_service.update_event(db, schema, event_actor.event)
    return event
...
async def patch_event_status(
    ...
    return await event_service.update_event_status(db, schema.new_status, event_id)
